    ...
    if (!document.getElementById('next-button')) {
        ...
        nextButton.addEventListener('click', function() {
            ...
            submitButton.addEventListener('click', function() {
                ...
                headerRow.style.setProperty('background-color', 'lightblue', 'important');
                // Insert the double line row after the header row
                var doubleLineRow = scoreTable.insertRow(headerRow.rowIndex + 1);
                var doubleLineCell = doubleLineRow.insertCell();
                doubleLineCell.colSpan = numberOfPlayers + 1; // Span across all columns
                doubleLineCell.style.borderTop = '3px double #000'; // Double line style
                // doubleLineCell.style.borderBottom = '3px double #000'; // Double line style
                // doubleLineCell.innerHTML = "&nbsp;"; // Add a non-breaking space to ensure the row has height
                }
               ...
               // Create a new row for the current round's scores
                ...
                if (!totalRow) {
                    ...
                    // Set the background color of the Total row to light blue
                ...
                if (!earningRow) {
                    ...
                    earningRow.style.backgroundColor = 'lightblue';
                }
                ...
                // Now call saveGameRecord to save the updated table
                saveGameRecord();
